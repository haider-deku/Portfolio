...
const Info = () => {
    return ( 
        <div className="about">
            <div className='part1'>
                <div className="pic">
                    <img src={haider} alt="haider youzbechi"></img>
                </div>
                <div className='desc'>
                    <h2>Haider Youzbechi<span>Computer science student</span></h2>
                    ...
                    <p><span>Date de naissance :</span> <br/> 28 november ,2004</p>
                </div>
            </div>
            <div className="part2">
                        <a href="https://github.com/haider-deku" target="_blank" rel="noopener noreferrer">
    <svg
